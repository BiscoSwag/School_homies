...
--
-- Host: 127.0.0.1
-- Creato il: Mar 30, 2025 alle 22:36
...
INSERT INTO `users` (`id_user`, `email`, `password`, `name`, `surname`, `bio`, `user_type`) VALUES
(1, 'mario.rossi@example.com', 'password123', 'Mario', 'Rossi', 't678yu8io', 'student'),
(2, 'luigi.verdi@example.com', 'password123', 'Luigi', 'Verdi', NULL, 'teacher'),
(3, 'anna.bianchi@example.com', 'password123', 'Anna', 'Bianchi', NULL, 'student'),
(4, 'Gianluca.marroni@example.com', '', 'gianluca', 'cognome', NULL, 'normale'),
(5, 'caccapalle@itisgalileiroma.it', '$2y$10$FKk9ypKm2ClCfKWeO3EkDuIdIGYBP3eXgNdumGY3kXLGvnCYcxlLO', 'cacca', 'palle', 'cacca', 'normale'),
(6, 'pisciocazzo@itisgalileiroma.it', '$2y$10$.mzEjA/INp64JrSHDYFe6OXX5Ou5Vi72eQHW12uFGyqUsMB2rzW2K', 'piscio', 'cazzo', NULL, 'normale');
